...
export default function Header() {
    ...
    const SearchButton = () =>{
        ...
        const{searchWord} = useParams(); //description: 여기 searchWord는 App.tsx의 SEARCH_PATH의 파라미터인 searchWord랑 동일해야됨//
        ...
        if(!status)
        //       render: 검색 버튼 컴포넌트  랜더링 클릭(false 상태d)     //
        return(
    ...
    <div id='header'>
        <div className='header-container'>
            <div className='header-left-box' onClick={onLogoClickHandler}>
                ...
                <div className='header-logo'>{'SeungJae Board'}</div>
            </div>
            <div className='header-right-box'>
                {(isAuthPage || isMainPage || isBoardDetailPage || isSearchPage) && <SearchButton/>}
